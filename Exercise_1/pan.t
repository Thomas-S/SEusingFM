...
{	Trans *T;
	...
	trans[0][1]	= settr(0,0,4,3,3,"x = (x+1)", 0, 2, 0); /* m: 2 -> 0,4 */
	reached0[2] = 1;
	trans[0][2]	= settr(0,0,0,0,0,"y = x",0,0,0);
	trans[0][3]	= settr(0,0,0,0,0,"assert((y==1))",0,0,0);
	trans[0][4]	= settr(3,0,0,4,4,"-end-", 0, 3500, 0);
	/* np_ demon: */
